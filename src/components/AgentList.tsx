...
const AgentList: React.FC = () => {
  ...
  const handleConnectToOllama = async (agentId: string) => {
    ...
    try {
      // In a real-world scenario, you would make an API call to Ollama here
      // For this example, we'll simulate the connection with a delay
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      // Simulating a successful connection
      connectAgentToOllama(agentId, 'llama3');
    } catch (error) {
